...
const ProfilePage: React.FC = () => {
  ...
  const bookmarkedResources = useMemo(() => {
    const allPublishedResources = [...RESOURCES, ...stories.filter(s => s.status === 'published')];
    return allPublishedResources.filter(r => bookmarks.includes(r.id));
  }, [allResources, bookmarks, stories]);
